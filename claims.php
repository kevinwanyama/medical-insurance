...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
      ...
      <li class="nav-item">
        <a class="nav-link" href="RECEPTION.php">CLIENT-REC</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="hsprec2.php">HSP-REC</a>
      </li>
      
      <li class="nav-item">
        <a class="nav-link" href="receptionlogin.php">EXIT PG</a>
      </li>
     ...
     <div class="row">
         <div class="col-md-12">
              <div class="page-header clearfix">
                  <h2 class="pull-left">HOSPITAL CLAIMS</h2>
                            ...
                            echo "<table id ='myTable'class='table table-bordered table-striped'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>" . $row['PHAMACY'] . "</td>";
                                        echo "<td>" . $row['DIAGNOSIS'] . "</td>";
                                        echo "<td>" . $row['LAB'] . "</td>";
                                        echo "<td>" . $row['HEMAIL'] . "</td>";
                                        echo "<td>" . $row['MEDICATION'] . "</td>";
                                        echo "<td>";
                                        echo "<a href='readK3.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip'><span class='glyphicon glyphicon-eye-open'></span></a>";
